...
abstract class ColorsValue {
  ...
  static const Color productCardColor = Color(productCardColorHex);
  ...
  static const int primaryColorHex = 0xff1BBCB6;

  static const int productCardColorHex = 0xffF8F8F8;
